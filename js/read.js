...
export function computeRead() {
  ...
  lastCalc = { r60:r, g30, g60, g120, fm, wx:{...wx}, fems:{...fems}, dm1, windDir };

  DIAG.ok('READ', `ROS=${r.ros.toFixed(1)} ft/min  FL=${r.flameLen.toFixed(0)} ft  I_b=${r.I_b.toFixed(0)} BTU/ft/s`);
